...
namespace VRCapture {
    ...
    public class VRCaptureVideo : MonoBehaviour {
        ...
        public TargetFramerateType targetFramerate = TargetFramerateType._60;
        ...
        public int TargetFramerate {
            get {
             ...
             /*   if (targetFramerate == TargetFramerateType._18) {
                    ...
                    framerate = 60;
                }else if (targetFramerate == TargetFramerateType._90)
                {
                    framerate = 90;
                }*/
                ...
                {
                    case TargetFramerateType._18:
                        framerate = 18;
                        break;
                    case TargetFramerateType._24:
                        framerate = 24;
                        break;
                    case TargetFramerateType._30:
                            framerate = 30;
                            break;
                    case TargetFramerateType._45:
                            framerate = 45;
                            break;
                    case TargetFramerateType._60:                
                            framerate = 60;
                        break;

                    case TargetFramerateType._90:
                        framerate = 90;
                        break;
                    default:
                       // throw new Exception("FRAMERATE UNKNOWN");
                        break;
                        }
                    return framerate;
            }
